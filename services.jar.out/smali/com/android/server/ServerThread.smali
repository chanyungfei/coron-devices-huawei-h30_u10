...
.method public run()V
    ...
    .line 281
    .local v151, telephonyRegistry3:Lcom/android/server/TelephonyRegistry;
    const/16 v152, 0x0

    .line 283
    .local v152, telephonyRegistry4:Lcom/android/server/TelephonyRegistry;
    const/16 v67, 0x0
    ...
    .line 298
    .local v160, uiHandlerThread:Landroid/os/HandlerThread;
    ...
    .line 352
    .local v125, msgMonitorService:Lcom/mediatek/common/msgmonitorservice/IMessageLogger;
    :try_start_2
    ...
    invoke-interface/range {v125 .. v125}, Lcom/mediatek/common/msgmonitorservice/IMessageLogger;->asBinder()Landroid/os/IBinder;
    ...
    .line 365
    .end local v125           #msgMonitorService:Lcom/mediatek/common/msgmonitorservice/IMessageLogger;
    :cond_1
    :goto_4
    :try_start_4
    const-string v7, "SystemServer"
    ...
    .local v150, telephonyRegistry2:Lcom/android/server/TelephonyRegistry;
    :try_start_7
    ...
    .end local v150           #telephonyRegistry2:Lcom/android/server/TelephonyRegistry;
    ...
    .line 619
    .local v153, thermalMgr:Lcom/mediatek/common/thermal/MtkThermalSwitchManager;
    const/16 v132, 0x0
    ...
    .line 751
    new-instance v171, Lcom/android/server/WifiService;
    ...
    .local v171, wifi:Lcom/android/server/WifiService;
    :try_start_2b
    ...
    .line 758
    .end local v171           #wifi:Lcom/android/server/WifiService;
    ...
    .line 764
    invoke-virtual/range {v170 .. v170}, Lcom/android/server/WifiService;->checkAndStartWifi()V
    ...
    .line 781
    new-instance v155, Lcom/android/server/ThrottleService;
    ...
    .local v155, throttle:Lcom/android/server/ThrottleService;
    :try_start_30
    ...
    .line 789
    .end local v155           #throttle:Lcom/android/server/ThrottleService;
    ...
    .line 865
    .local v140, searchEngineService:Lcom/mediatek/common/search/ISearchEngineManagerService;
    :try_start_3d
    ...
    invoke-interface/range {v140 .. v140}, Lcom/mediatek/common/search/ISearchEngineManagerService;->asBinder()Landroid/os/IBinder;
    ...
    .line 881
    .end local v140           #searchEngineService:Lcom/mediatek/common/search/ISearchEngineManagerService;
    :cond_c
    :goto_2b
    :try_start_3f
    const-string v7, "SystemServer"
    ...
    .line 1131
    new-instance v133, Lcom/android/server/PerfMgrStateNotifier;

    invoke-direct/range {v133 .. v133}, Lcom/android/server/PerfMgrStateNotifier;-><init>()V
    :try_end_5f
    ...
    .local v133, perfMgrNotifier:Lcom/android/server/PerfMgrStateNotifier;
    :try_start_60
    invoke-static {}, Lcom/android/server/am/ActivityManagerService;->self()Lcom/android/server/am/ActivityManagerService;
    ...
    .end local v133           #perfMgrNotifier:Lcom/android/server/PerfMgrStateNotifier;
    ...
    move-object/from16 v61, v151

    .line 1254
    .local v61, telephonyRegistryF3:Ljava/lang/Object;
    move-object/from16 v62, v152
    ...
    .end local v147           #telephonyRegistry:Lcom/android/server/TelephonyRegistry;
    .end local v149           #telephonyRegistry2:Lcom/android/server/TelephonyRegistry;
    .end local v151           #telephonyRegistry3:Lcom/android/server/TelephonyRegistry;
    .end local v152           #telephonyRegistry4:Lcom/android/server/TelephonyRegistry;
    .end local v153           #thermalMgr:Lcom/mediatek/common/thermal/MtkThermalSwitchManager;
    .end local v154           #throttle:Lcom/android/server/ThrottleService;
    .end local v156           #tsms:Lcom/android/server/TextServicesManagerService;
    .end local v158           #twilight:Lcom/android/server/TwilightService;
    .end local v160           #uiHandlerThread:Landroid/os/HandlerThread;
    .end local v161           #uiMode:Lcom/android/server/UiModeManagerService;
    .end local v163           #usb:Lcom/android/server/usb/UsbService;
    .end local v165           #vibrator:Lcom/android/server/VibratorService;
    ...
    .restart local v123       #mountService:Lcom/android/server/MountService;
    .restart local v125       #msgMonitorService:Lcom/mediatek/common/msgmonitorservice/IMessageLogger;
    ...
    .restart local v147       #telephonyRegistry:Lcom/android/server/TelephonyRegistry;
    .restart local v149       #telephonyRegistry2:Lcom/android/server/TelephonyRegistry;
    .restart local v151       #telephonyRegistry3:Lcom/android/server/TelephonyRegistry;
    .restart local v152       #telephonyRegistry4:Lcom/android/server/TelephonyRegistry;
    .restart local v154       #throttle:Lcom/android/server/ThrottleService;
    .restart local v158       #twilight:Lcom/android/server/TwilightService;
    .restart local v160       #uiHandlerThread:Landroid/os/HandlerThread;
    .restart local v161       #uiMode:Lcom/android/server/UiModeManagerService;
    .restart local v163       #usb:Lcom/android/server/usb/UsbService;
    .restart local v165       #vibrator:Lcom/android/server/VibratorService;
    .restart local v170       #wifi:Lcom/android/server/WifiService;
    ...
    :cond_1c
    :try_start_6d
    new-instance v148, Lcom/android/server/StubTelephonyRegistry;
    ...
    .restart local v150       #telephonyRegistry2:Lcom/android/server/TelephonyRegistry;
    :cond_1d
    :try_start_6e
    const-string v7, "1"
    ...
    const-string v9, "wifi display is on, close it "
    ...
    invoke-static {v7, v9, v11}, Landroid/provider/Settings$Global;->putInt(Landroid/content/ContentResolver;Ljava/lang/String;I)Z
    ...
    .restart local v145       #statusBar:Lcom/android/server/StatusBarManagerService;
    .restart local v149       #telephonyRegistry2:Lcom/android/server/TelephonyRegistry;
    .restart local v153       #thermalMgr:Lcom/mediatek/common/thermal/MtkThermalSwitchManager;
    .restart local v156       #tsms:Lcom/android/server/TextServicesManagerService;
    .restart local v165       #vibrator:Lcom/android/server/VibratorService;
    .restart local v168       #wallpaper:Lcom/android/server/WallpaperManagerService;
    :catch_6
    ...
    .line 867
    .end local v102           #e:Ljava/lang/Throwable;
    .restart local v140       #searchEngineService:Lcom/mediatek/common/search/ISearchEngineManagerService;
    :catch_20
    move-exception v102
    ...
    .restart local v76       #audioProfileService:Lcom/mediatek/common/audioprofile/IAudioProfileService;
    .restart local v103       #epoMgr:Lcom/mediatek/common/epo/IMtkEpoClientManager;
    .restart local v133       #perfMgrNotifier:Lcom/android/server/PerfMgrStateNotifier;
    :catch_48
    move-exception v102
    ...
    .line 784
    .end local v154           #throttle:Lcom/android/server/ThrottleService;
    .restart local v155       #throttle:Lcom/android/server/ThrottleService;
    :catch_52
    move-exception v102
    ...
    .line 753
    .end local v170           #wifi:Lcom/android/server/WifiService;
    .restart local v171       #wifi:Lcom/android/server/WifiService;
    :catch_54
    move-exception v102
