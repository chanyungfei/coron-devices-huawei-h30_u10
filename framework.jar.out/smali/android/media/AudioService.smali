...
.field private static final RING_VOLUME_HEADSET:I = 0x5
...
.field private mUserRingVolume:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, v0, Landroid/media/AudioService;->mUserRingVolume:I
...
.method private onSetWiredDeviceConnectionState(IILjava/lang/String;)V
    ...
    const-string/jumbo v6, "onSetWiredDeviceConnectionState:device:"
    ...
    const-string/jumbo v5, "onSetWiredDeviceConnectionState() no need to setForceUse"
    ...
    invoke-virtual {v0, v4}, Landroid/media/AudioService;->setBluetoothA2dpOnInt(Z)V

    .line 4241
    .end local v11           #isHeadphoneOff:Z
    .end local v12           #isHeadsetOn:Z
    :cond_2
    move/from16 v0, p1
    ...
    invoke-direct {v0, v5, v1, v4}, Landroid/media/AudioService;->handleDeviceConnection(ZILjava/lang/String;)Z
    ...
    invoke-virtual {v0, v4}, Landroid/media/AudioService;->getStreamVolume(I)I

    move-result v14

    .line 4246
    .local v14, ringVolume:I
    if-eqz p2, :cond_b
    ...
    iput v14, v0, Landroid/media/AudioService;->mUserRingVolume:I
    ...
    invoke-virtual {v0, v4, v5, v6}, Landroid/media/AudioService;->setStreamVolume(III)V
    ...
    invoke-direct {v0, v1, v2, v3, v15}, Landroid/media/AudioService;->sendDeviceConnectionIntent(IILjava/lang/String;Z)V
    ...
    .line 4269
    .restart local v14       #ringVolume:I
    :cond_b
    const/4 v4, 0x4
    ...
    const-string/jumbo v6, "mUserRingVolume="
    ...
    iget v6, v0, Landroid/media/AudioService;->mUserRingVolume:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, ",ringVolume="
    ...
    iget v4, v0, Landroid/media/AudioService;->mUserRingVolume:I
    ...
    iget v5, v0, Landroid/media/AudioService;->mUserRingVolume:I
    ...
    iput v4, v0, Landroid/media/AudioService;->mUserRingVolume:I
