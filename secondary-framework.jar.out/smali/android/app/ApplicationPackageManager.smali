...
.method public getInstalledApplications(I)Ljava/util/List;
    ...
    invoke-virtual {v7}, Landroid/app/ContextImpl;->getUserId()I
    ...
    const-string v8, "getInstalledApplications begin!"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 462
    new-instance v4, Lcom/huawei/permission/PackageListPermission;

    iget-object v7, p0, Landroid/app/ApplicationPackageManager;->mContext:Landroid/app/ContextImpl;

    invoke-direct {v4, v7}, Lcom/huawei/permission/PackageListPermission;-><init>(Landroid/content/Context;)V

    .line 463
    .local v4, packageListPermission:Lcom/huawei/permission/PackageListPermission;
    invoke-static {}, Landroid/os/Process;->myUid()I

    move-result v7

    invoke-virtual {v4, v7}, Lcom/huawei/permission/PackageListPermission;->isGetPackageListBlocked(I)Z
    ...
    const-string v8, "getInstalledApplications refuse!"
    ...
    const-string v8, "getInstalledApplications end!"
    ...
    invoke-interface {v7, p1, v3, v6}, Landroid/content/pm/IPackageManager;->getInstalledApplications(ILjava/lang/String;I)Landroid/content/pm/ParceledListSlice;

    move-result-object v5

    .line 473
    .local v5, slice:Landroid/content/pm/ParceledListSlice;,"Landroid/content/pm/ParceledListSlice<Landroid/content/pm/ApplicationInfo;>;"
    sget-object v7, Landroid/content/pm/ApplicationInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v5, v0, v7}, Landroid/content/pm/ParceledListSlice;->populateList(Ljava/util/List;Landroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    invoke-virtual {v5}, Landroid/content/pm/ParceledListSlice;->isLastSlice()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v5           #slice:Landroid/content/pm/ParceledListSlice;,"Landroid/content/pm/ParceledListSlice<Landroid/content/pm/ApplicationInfo;>;"
    :cond_2
    const/4 v3, 0x0
    ...
    .end local v2           #lastItem:Landroid/content/pm/ApplicationInfo;
    .end local v4           #packageListPermission:Lcom/huawei/permission/PackageListPermission;
    :catch_0
    move-exception v1
    ...
    const-string v8, "Package manager has died"
...
.method public getInstalledPackages(II)Ljava/util/List;
    ...
    const-string v7, "getInstalledPackages begin!"
    ...
    invoke-direct {v4, v6}, Lcom/huawei/permission/PackageListPermission;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v6}, Lcom/huawei/permission/PackageListPermission;->isGetPackageListBlocked(I)Z
    ...
    const-string v7, "getInstalledPackages refuse!"
    ...
    const-string v7, "getInstalledPackages end!"
    ...
    invoke-interface {v6, p1, v2, p2}, Landroid/content/pm/IPackageManager;->getInstalledPackages(ILjava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-virtual {v5, v3, v6}, Landroid/content/pm/ParceledListSlice;->populateList(Ljava/util/List;Landroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
...
.method public resolveActivityAsUser(Landroid/content/Intent;II)Landroid/content/pm/ResolveInfo;
    ...
    const-string v3, "resolveActivityAsUser begin!"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 491
    new-instance v1, Lcom/huawei/permission/PackageListPermission;

    iget-object v2, p0, Landroid/app/ApplicationPackageManager;->mContext:Landroid/app/ContextImpl;

    invoke-direct {v1, v2}, Lcom/huawei/permission/PackageListPermission;-><init>(Landroid/content/Context;)V

    .line 492
    .local v1, packageListPermission:Lcom/huawei/permission/PackageListPermission;
    invoke-static {}, Landroid/os/Process;->myUid()I

    move-result v2

    invoke-virtual {v1, v2}, Lcom/huawei/permission/PackageListPermission;->isGetPackageListBlocked(I)Z
    ...
    const-string v3, "resolveActivityAsUser refuse!"
    ...
    const-string v3, "resolveActivityAsUser end!"
