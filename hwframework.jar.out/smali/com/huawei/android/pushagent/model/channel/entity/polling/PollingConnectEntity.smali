...
.method public declared-synchronized connect(Z)V
    ...
    invoke-virtual {v1}, Lcom/huawei/android/pushagent/datatype/TRSRetInfo;->isValidPolling()Z
    :try_end_0
...
.method public notifyEvent(Lcom/huawei/android/pushagent/model/channel/entity/SocketReadThread$SocketEvent;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v5}, Lcom/huawei/android/pushagent/datatype/TRSRetInfo;->getPollingId()I

    move-result v5

    invoke-direct {v4, v5}, Lcom/huawei/android/pushagent/datatype/pollingmessage/PollingDataReqMessage;-><init>(I)V

    invoke-virtual {p0, v4}, Lcom/huawei/android/pushagent/model/channel/entity/ConnectEntity;->send(Lcom/huawei/android/pushagent/datatype/IPushMessage;)Z
    ...
    invoke-virtual {v5}, Lcom/huawei/android/pushagent/datatype/TRSRetInfo;->getSocketReadTimeOut()J
