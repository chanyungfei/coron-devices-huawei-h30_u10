...
#-----------------------------------------------------------------------------
vendor_remove_files := set_immutable.list ons.bin
...
#-----------------------------------------------------------------------------
vendor_modify_jars := framework hwframework mediatek-framework mediatek-telephony-common pm secondary-framework services telephony-common
...
#-----------------------------------------------------------------------------
baidu_remove_apps := BaiduAppSearch BaiduBrowser BaiduMap BaiduUpdate HomePro YiYueDu iReader
...
override_property += \
    romjd.rom.id=0c3ceddd-9cce-4d6c-a050-de32795d9a36 \
